...
ScrollReveal().reveal('.home-content a', { origin: 'bottom', delay: 1500 });

// for depertment section
ScrollReveal().reveal('.single-card-1', { origin: 'left' });
ScrollReveal().reveal('.single-card-2', { origin: 'bottom' });
ScrollReveal().reveal('.single-card-3', { origin: 'right' });
